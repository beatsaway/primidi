...
(function() {
    ...
    async function requestMIDIAccess() {
        try {
            ...
            // Silently handle MIDI access denial - this is expected if user denies permission or no MIDI devices available
            if (error.name !== 'NotAllowedError') {
                // Only log non-permission errors (e.g., browser doesn't support MIDI)
                console.log('MIDI not available:', error.name);
            }
        }
    }
